...
- fix: adapt tests to SessionManager without default\_session [\#205](https://github.com/OpenVoiceOS/ovos-media/pull/205) ([JarbasAl](https://github.com/JarbasAl))
...
- test: follow ovos-utils length sanitisation in the MPRIS exporter [\#176](https://github.com/OpenVoiceOS/ovos-media/pull/176) ([JarbasAl](https://github.com/JarbasAl))
...
- refactor: split mpris into loop, exporter and external-player manager [\#170](https://github.com/OpenVoiceOS/ovos-media/pull/170) ([JarbasAl](https://github.com/JarbasAl))
...
- refactor: player adapter roster over backend services [\#164](https://github.com/OpenVoiceOS/ovos-media/pull/164) ([JarbasAl](https://github.com/JarbasAl))
