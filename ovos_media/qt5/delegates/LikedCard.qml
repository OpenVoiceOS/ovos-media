...
ItemDelegate {
    ...
    readonly property bool isCurrent: {
        likedListView.currentIndex == index && activeFocus && !likedListView
        .moving
    }
    ...
    onClicked: {
        ...
        likedListView.currentIndex = index
        triggerGuiEvent("liked_tracks.play",
        {"title": model.title, "uri": model.uri, "image": model.image})
    }
}
